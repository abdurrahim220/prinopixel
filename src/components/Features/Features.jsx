  ...
  return (
    <div class="max-w-4xl mx-auto px-5 mt-16">
      <div class="text-center">
        <h2 class="font-semibold text-3xl text-action-heading">
          Features you'll love
        </h2>
        <p class="max-w-md mx-auto mt-4 text-action-desc">
          A responsive documentation template built for everyone who wants to
          create a plugin form const first = useRef(second).
        </p>
      </div>
      ...
      <div class="grid md:grid-cols-2 gap-10 mt-10">
        <div class="flex gap-4 items-start">
          ...
          <div>
            <h3 class="font-semibold text-xl text-action-heading">
              Customizable
            </h3>
            <p class="mt-1 text-action-desc">
              {" "}
